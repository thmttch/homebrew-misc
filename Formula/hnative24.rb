...
class Hnative24 < Formula
  ...
  sha256 "c7750fe6dea15cd352e1178ad1783e3b8571756b0e6882dbcde6a1521f7be827"
  ...
  depends_on "openssl" => :build
    ...
    patch do
      url "https://issues.apache.org/jira/secure/attachment/12617363/HADOOP-9648.v2.patch"
      #sha256 ""
    end
